...
const THEME_MAP = {
  'classic-cream': {
    ...
    sidebarInactive: 'text-zinc-500 hover:text-zinc-950 hover:bg-zinc-200/60',
  ...
  'soft-lavender': {
    ...
    card: 'bg-white border-purple-100 text-purple-900',
    ...
    sidebarInactive: 'text-purple-600 hover:text-purple-900 hover:bg-purple-200/60',
    sidebarCard: 'bg-white border-purple-200/60 shadow-sm',
    sidebarCardTitle: 'text-purple-500',
  ...
  'slate-grey': {
    ...
    sidebarInactive: 'text-slate-600 hover:text-slate-950 hover:bg-slate-200/60',
    sidebarCard: 'bg-white border-slate-200/60 shadow-sm',
    sidebarCardTitle: 'text-slate-400',
  ...
  'peach-blossom': {
    ...
    card: 'bg-white border-orange-100 text-orange-950',
    ...
    sidebarInactive: 'text-orange-600 hover:text-orange-950 hover:bg-orange-200/60',
    sidebarCard: 'bg-white border-orange-200/60 shadow-sm',
    sidebarCardTitle: 'text-orange-500',
  ...
  'powder-blue': {
    ...
    card: 'bg-white border-sky-100 text-sky-950',
    text: 'text-sky-950',
    ...
    sidebarInactive: 'text-sky-600 hover:text-sky-950 hover:bg-sky-200/60',
  ...
  'rose-petal': {
    ...
    card: 'bg-white border-rose-100 text-rose-950',
    text: 'text-rose-950',
    ...
    sidebarInactive: 'text-rose-600 hover:text-rose-950 hover:bg-rose-200/60',
    sidebarCard: 'bg-white border-rose-200/60 shadow-sm',
    sidebarCardTitle: 'text-rose-500',
  ...
  'mint-green': {
    ...
    card: 'bg-white border-teal-100 text-black dark:text-black',
    ...
    sidebarActive: 'bg-teal-600 text-white shadow-md font-extrabold',
    sidebarInactive: 'text-teal-700 dark:text-teal-700 hover:text-black hover:bg-teal-100',
    sidebarCard: 'bg-white border-teal-200/60 shadow-sm',
    sidebarCardTitle: 'text-teal-500',
  ...
  'warm-sand': {
    ...
    card: 'bg-white border-amber-200 text-amber-900',
    text: 'text-amber-900',
    subText: 'text-amber-600',
    badge: 'bg-amber-500/10 text-amber-600 border-amber-500/20',
    sidebar: 'bg-[#F5F2E8] text-amber-900 border-amber-200/60',
    sidebarActive: 'bg-amber-700 text-white shadow-md font-extrabold',
    sidebarInactive: 'text-amber-700 hover:text-amber-950 hover:bg-amber-200/60',
  ...
  'silver-lilac': {
    ...
    card: 'bg-white border-indigo-100 text-black dark:text-black',
    text: 'text-black dark:text-black',
    subText: 'text-zinc-800 dark:text-zinc-800',
    badge: 'bg-indigo-500/10 text-indigo-600 border-indigo-500/20',
    sidebar: 'bg-[#F3EEFA] text-indigo-800 border-indigo-200/60',
    sidebarActive: 'bg-indigo-600 text-white shadow-md font-extrabold',
    sidebarInactive: 'text-indigo-600 dark:text-indigo-600 hover:text-black hover:bg-indigo-100',
    sidebarCard: 'bg-white border-indigo-100 shadow-sm',
    sidebarCardTitle: 'text-indigo-600',
